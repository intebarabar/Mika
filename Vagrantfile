...
Vagrant.configure("2") do |config|
    ...
    config.vm.provider "virtualbox" do |v|
        ...
        v.customize ["modifyvm", :id, "--name", "bargrossisten.local"]
    ...
    config.vm.hostname = "bargrossisten.local"
    ...
    #On Windows synced folders
        ...
        config.vm.provision :shell, path: "ansible/windows.sh", args: ["bargrossisten.local"]
end
