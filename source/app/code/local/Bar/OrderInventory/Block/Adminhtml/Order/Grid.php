...
class Bar_OrderInventory_Block_Adminhtml_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        if (isset($enabledCustomGrid) && $enabledCustomGrid == 1) {
            ...
            foreach ($selectedColumnsArray as $orderColumn) {
                switch ($orderColumn) {
                    ...
                    case 'product_detail':
                        ...
                        if ($params == 'adminhtml_sales_order_exportCsv' || $params == 'adminhtml_sales_order_exportExcel') {
                        } else {
                            ...
                            $this->addColumn('name', array(
                                ...
                                'index' => 'name',
                                'type' => 'text',
                                'renderer' => new Bar_OrderInventory_Block_Adminhtml_Ordermanager_Grid_Renderer_Target(), // show products row
                            ));
                        }
                        break;
            ...
            return Mage_Adminhtml_Block_Sales_Order_Grid::_prepareColumns();
        }
    }
