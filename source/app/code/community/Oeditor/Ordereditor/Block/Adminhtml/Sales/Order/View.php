	...
	public function  __construct() {
		...
		$canInvoice = $order->canInvoice();
		 ...
		 if ($order->hasInvoices() || $order->hasShipments() || $order->getState() == 'closed' ) 
		 {
			...
			$deleteInvoiceShipMemoPath = $this->getUrl('adminhtml/ordereditor/deleteInvoiceShipCreditMemo').'?order_id='.$orderId;
	...
	/*	if ($order->hasInvoices() || $order->hasShipments() || $order->getState() == 'closed' ) 
		{
			...
			$resetItemStatusPath = $this->getUrl('adminhtml/ordereditor/resetItemStatus').'?order_id='.$orderId;
		...
		*/
			...
			$deleteOrderAction = $this->getUrl('adminhtml/ordereditor/deleteOrder').'?order_id='.$orderId;
