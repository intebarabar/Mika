        ...
        if (type != 'item') {
            ...
            ajaxcart_timer = setInterval(function () {
                jQuery('#after-loading-success-message .timer').html(jQuery('#after-loading-success-message .timer').text() - 1),
                    jQuery('.header-container.type8 .container .header .header-right .topCartContent').css('display', 'block'),
                    jQuery('.header-container.type8.clone .container .header .header-right .topCartContent').css('display', 'none');
            }, 1)
            setTimeout(function () {
...
jQuery(function ($) {
    $(document).click(function (e) {
        if (!($(e.target).hasClass('topCartContent'))
            && $(e.target).parents('.topCartContent').length === 0) {
            $('.topCartContent').hide();
        }
    })
});
